  ...
  try {
    ...
    const html = template
      .replace(
        ...
        `
        ${rendered.head ?? ''}
        <meta property="og:title" content="${clientInfo.name ?? 'Default Title'}" />
        <meta property="og:description" content="${clientInfo.description ?? 'Default Description'}" />
        <meta property="og:image" content="${clientInfo.image ?? 'default-image-url'}" />
